...
* [:computer: Code](https://github.com/deepmind/alphafold) ⭐ 14,814 | 🐛 307 | 🌐 Python | 📅 2026-04-22
...
* [:floppy\_disk: Code](https://github.com/deepmind/deepmind-research/tree/master/alphafold_casp13) ⭐ 15,170 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17
...
[AutoDock GPU](https://github.com/ccsb-scripps/AutoDock-GPU) ⭐ 610 | 🐛 87 | 🌐 C++ | 📅 2026-08-11

* [:book: Paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3041641/)

[Gnina](https://github.com/gnina/gnina) ⭐ 966 | 🐛 24 | 🌐 C++ | 📅 2026-06-29 - deep learning framework for molecular docking -inside deepchem (/dock/pose\_generation.py)

[GOMoDo](https://gomodo.grs.kfa-juelich.de/php/about.php) - GPCR online modeling and docking server

[Smina](https://github.com/mwojcikowski/smina) ⭐ 149 | 🐛 0 | 🌐 C++ | 📅 2018-11-18 used for minimization (local\_only) as opposed to of docking, makes Vina much easer to use and 10-20x faster. Docking performance is about the same since partial charge calculation and file i/o isn't such a big part of the performance.
...
[Jaffa](https://github.com/Oshlack/JAFFA) ⭐ 117 | 🐛 19 | 🌐 C++ | 📅 2026-08-25 - JAFFA is a multi-step pipeline that takes either raw RNA-Seq reads, or pre-assembled transcripts, then searches for gene fusions
...
[Deep Variant](https://github.com/google/deepvariant) ⭐ 3,795 | 🐛 5 | 🌐 Python | 📅 2026-03-19 - analysis pipeline that uses a deep neural network to call genetic variants from next-generation DNA sequencing data
...
[BioWasm](https://github.com/biowasm/biowasm) ⭐ 277 | 🐛 10 | 🌐 HTML | 📅 2026-08-05 - WebAssembly modules for genomics
...
[VG](https://github.com/vgteam/vg) ⭐ 1,334 | 🐛 382 | 🌐 C++ | 📅 2026-08-28 - tools for working with genome variation graphs
...
(2019) [Junction Tree Variational Autoencoder for Molecular Graph Generation](https://arxiv.org/pdf/1802.04364.pdf) --> :computer: [Code](https://github.com/wengong-jin/icml18-jtnn) ⭐ 565 | 🐛 30 | 🌐 Python | 📅 2022-12-01
...
* [Polars](https://github.com/pola-rs/polars) ⭐ 39,528 | 🐛 2,871 | 🌐 Rust | 📅 2026-08-28 - everyone learns the hard way that Pandas doesn't cut it in the real world. Its like [Arrow](https://github.com/apache/arrow) ⭐ 17,068 | 🐛 2,582 | 🌐 C++ | 📅 2026-08-28 only Rusty.
* [Jax](https://github.com/google/jax) ⭐ 36,220 | 🐛 2,492 | 🌐 Python | 📅 2026-08-28 - the future? of domain specific ML compiling?
...
If you didn't know jax's [nn.logsoftmax](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/nn/functions.py#L264) ⭐ 36,220 | 🐛 2,492 | 🌐 Python | 📅 2026-08-28 AF2's implemenation would not mean much to you.
...
* [`lax.stop_gradient`](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/lax/lax.py#L1661) ⭐ 36,220 | 🐛 2,492 | 🌐 Python | 📅 2026-08-28 - is the identity function, that is, it returns argument `x` unchanged. However, `stop_gradient` prevents the flow of
...
This in turn relies upon [`tree_map`](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/tree_util.py#L144) ⭐ 36,220 | 🐛 2,492 | 🌐 Python | 📅 2026-08-28
...
[Jax MD](https://github.com/google/jax-md) ⭐ 1,458 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2026-08-18
...
[Artificial Intelligence: A Modern Approach](https://github.com/aimacode/aima-python) ⭐ 8,800 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-06-30 🤖 The Gospel of Machine Learning
