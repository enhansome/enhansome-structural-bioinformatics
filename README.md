...
* [:computer: Code](https://github.com/deepmind/alphafold) ⭐ 14,785 | 🐛 306 | 🌐 Python | 📅 2026-04-22
...
* [:floppy\_disk: Code](https://github.com/deepmind/deepmind-research/tree/master/alphafold_casp13) ⭐ 15,149 | 🐛 341 | 🌐 Jupyter Notebook | 📅 2026-06-17
...
[AutoDock GPU](https://github.com/ccsb-scripps/AutoDock-GPU) ⭐ 606 | 🐛 87 | 🌐 C++ | 📅 2026-08-11

* [:book: Paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3041641/)

[Gnina](https://github.com/gnina/gnina) ⭐ 960 | 🐛 25 | 🌐 C++ | 📅 2026-06-29 - deep learning framework for molecular docking -inside deepchem (/dock/pose\_generation.py)

[GOMoDo](https://gomodo.grs.kfa-juelich.de/php/about.php) - GPCR online modeling and docking server

[Smina](https://github.com/mwojcikowski/smina) ⭐ 147 | 🐛 0 | 🌐 C++ | 📅 2018-11-18 used for minimization (local\_only) as opposed to of docking, makes Vina much easer to use and 10-20x faster. Docking performance is about the same since partial charge calculation and file i/o isn't such a big part of the performance.
...
[Deep Variant](https://github.com/google/deepvariant) ⭐ 3,777 | 🐛 5 | 🌐 Python | 📅 2026-03-19 - analysis pipeline that uses a deep neural network to call genetic variants from next-generation DNA sequencing data
...
[gBWT](https://github.com/jltsiren/gbwt) ⭐ 62 | 🐛 1 | 🌐 C++ | 📅 2026-07-07 -  graph extension (gPBWT) of the positional Burrows-Wheeler transform (PBWT)

* [gBWT in Rust](https://github.com/jltsiren/gbwt-rs) ⭐ 46 | 🐛 1 | 🌐 Rust | 📅 2026-08-12

[VG](https://github.com/vgteam/vg) ⭐ 1,333 | 🐛 401 | 🌐 C++ | 📅 2026-08-12 - tools for working with genome variation graphs
...
(2021) [JANUS: Parallel Tempered Genetic Algorithm Guided by Deep Neural Networks for Inverse Molecular Design](https://arxiv.org/pdf/2106.04011.pdf) --> :computer: [code](https://github.com/aspuru-guzik-group/JANUS) ⭐ 90 | 🐛 2 | 🌐 Python | 📅 2022-07-27
...
(2020) [Hierarchical Generation of Molecular Graphs using Structural Motifs](https://arxiv.org/pdf/2002.03230.pdf) --> :computer: [code](https://github.com/wengong-jin/hgraph2graph/) ⭐ 441 | 🐛 44 | 🌐 Python | 📅 2022-06-28
...
(2019) [Molecular Property Prediction: A Multilevel Quantum Interactions Modeling Perspective](https://gitlab.com/7tm/smel/-/blob/master/papers/molecular_property_prediction.pdf) --> :computer: [code](https://github.com/awslabs/dgl-lifesci/blob/master/python/dgllife/model/model_zoo/mgcn_predictor.py) ⭐ 808 | 🐛 32 | 🌐 Python | 📅 2023-11-01 --> :computer: [more code](https://github.com/tencent-alchemy/Alchemy) ⭐ 114 | 🐛 6 | 🌐 Python | 📅 2024-07-25
...
* [Polars](https://github.com/pola-rs/polars) ⭐ 39,343 | 🐛 2,843 | 🌐 Rust | 📅 2026-08-12 - everyone learns the hard way that Pandas doesn't cut it in the real world. Its like [Arrow](https://github.com/apache/arrow) ⭐ 17,016 | 🐛 2,565 | 🌐 C++ | 📅 2026-08-13 only Rusty.
* [Jax](https://github.com/google/jax) ⭐ 36,155 | 🐛 2,569 | 🌐 Python | 📅 2026-08-13 - the future? of domain specific ML compiling?
* [Annoy](https://github.com/spotify/annoy) ⭐ 14,282 | 🐛 84 | 🌐 C++ | 📅 2025-10-29 - the standard in production nearest neighbor
...
If you didn't know jax's [nn.logsoftmax](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/nn/functions.py#L264) ⭐ 36,155 | 🐛 2,569 | 🌐 Python | 📅 2026-08-13 AF2's implemenation would not mean much to you.
...
* [`lax.stop_gradient`](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/lax/lax.py#L1661) ⭐ 36,155 | 🐛 2,569 | 🌐 Python | 📅 2026-08-13 - is the identity function, that is, it returns argument `x` unchanged. However, `stop_gradient` prevents the flow of
...
This in turn relies upon [`tree_map`](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/tree_util.py#L144) ⭐ 36,155 | 🐛 2,569 | 🌐 Python | 📅 2026-08-13
...
[Jax MD](https://github.com/google/jax-md) ⭐ 1,451 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2026-07-26
