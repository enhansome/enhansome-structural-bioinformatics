# Awesome Structural BioInformatics with stars
...
[Proteins](https://github.com/Ramb0a/awesome-structural-bioinformatics#protein-bioinformatics) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2023-05-05

[Genomics](https://github.com/Ramb0a/awesome-structural-bioinformatics#genomics) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2023-05-05
...
* [:computer: Code](https://github.com/deepmind/alphafold) ⭐ 14,798 | 🐛 306 | 🌐 Python | 📅 2026-04-22
...
* [:floppy\_disk: Code](https://github.com/deepmind/deepmind-research/tree/master/alphafold_casp13) ⭐ 15,159 | 🐛 341 | 🌐 Jupyter Notebook | 📅 2026-06-17
...
[ 💻 Github](https://github.com/ba-lab/pdnet/) ⭐ 36 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2021-05-30
...
[AutoDock GPU](https://github.com/ccsb-scripps/AutoDock-GPU) ⭐ 607 | 🐛 87 | 🌐 C++ | 📅 2026-08-11

* [:book: Paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3041641/)

[Gnina](https://github.com/gnina/gnina) ⭐ 963 | 🐛 25 | 🌐 C++ | 📅 2026-06-29 - deep learning framework for molecular docking -inside deepchem (/dock/pose\_generation.py)

[GOMoDo](https://gomodo.grs.kfa-juelich.de/php/about.php) - GPCR online modeling and docking server

[Smina](https://github.com/mwojcikowski/smina) ⭐ 148 | 🐛 0 | 🌐 C++ | 📅 2018-11-18 used for minimization (local\_only) as opposed to of docking, makes Vina much easer to use and 10-20x faster. Docking performance is about the same since partial charge calculation and file i/o isn't such a big part of the performance.
...
[ChimPipe](https://github.com/Chimera-tools/ChimPipe#:~:text=ChimPipe%20is%20a%20computational%20method,junctions%20at%20base%2Dpair%20resolution.) ⭐ 15 | 🐛 1 | 🌐 Awk | 📅 2026-01-22 - ChimPipe is a computational method for the detection of novel transcription-induced chimeric transcripts and fusion genes from Illumina Paired-End RNA-seq data. It combines junction spanning and paired-end read information to accurately detect chimeric splice junctions at base-pair resolution.

[DeepNF](https://github.com/VGligorijevic/deepNF) ⭐ 32 | 🐛 6 | 🌐 Python | 📅 2020-05-04 - Deep network fusion for protein function prediction | 📖 [paper](https://academic.oup.com/bioinformatics/article/34/22/3873/5026651)

[DeepPrior](https://github.com/bioinformatics-polito/DEEPrior) ⭐ 6 | 🐛 4 | 🌐 Python | 📅 2023-05-22 - predicts the probability of a gene fusion being a driver of an oncogenic process by directly exploiting the amino acid sequence of the fused protein, and it can prioritize gene fusions from different tumors. Unlike state-of-the-art tools, it also supports easy retraining and re-adaptation of the model | 📖 [paper](https://academic.oup.com/bioinformatics/article/36/10/3248/5722203)

[DeFuse](https://github.com/amcpherson/defuse) ⭐ 8 | 🐛 3 | 🌐 C++ | 📅 2021-02-15 - gene fusion discovery using RNA-Seq data. The software uses clusters of discordant paired end alignments to inform a split read alignment analysis for finding fusion boundaries | 📖 [paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3098195/)
...
[Jaffa](https://github.com/Oshlack/JAFFA) ⭐ 116 | 🐛 19 | 🌐 C++ | 📅 2026-08-08 - JAFFA is a multi-step pipeline that takes either raw RNA-Seq reads, or pre-assembled transcripts, then searches for gene fusions
...
[Deep Variant](https://github.com/google/deepvariant) ⭐ 3,785 | 🐛 6 | 🌐 Python | 📅 2026-03-19 - analysis pipeline that uses a deep neural network to call genetic variants from next-generation DNA sequencing data
...
[BioWasm](https://github.com/biowasm/biowasm) ⭐ 276 | 🐛 10 | 🌐 HTML | 📅 2026-08-05 - WebAssembly modules for genomics
...
* [gBWT in Rust](https://github.com/jltsiren/gbwt-rs) ⭐ 46 | 🐛 1 | 🌐 Rust | 📅 2026-08-21

[VG](https://github.com/vgteam/vg) ⭐ 1,333 | 🐛 400 | 🌐 C++ | 📅 2026-08-21 - tools for working with genome variation graphs
...
(2021) [JANUS: Parallel Tempered Genetic Algorithm Guided by Deep Neural Networks for Inverse Molecular Design](https://arxiv.org/pdf/2106.04011.pdf) --> :computer: [code](https://github.com/aspuru-guzik-group/JANUS) ⭐ 91 | 🐛 2 | 🌐 Python | 📅 2022-07-27
...
(2021) [Few-Shot Graph Learning for Molecular Property Prediction](https://gitlab.com/7tm/smel/-/blob/master/papers/few_shot_graph_learning.pdf) --> :computer: [code](https://github.com/zhichunguo/Meta-MGNN) ⭐ 138 | 🐛 4 | 🌐 Python | 📅 2023-02-20
...
(2020) [Mol-CycleGAN: a generative model for molecular optimization](https://jcheminf.biomedcentral.com/articles/10.1186/s13321-019-0404-1) --> :computer: [code](https://github.com/ardigen/mol-cycle-gan) ⭐ 76 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2019-02-06
...
(2020) [Hierarchical Generation of Molecular Graphs using Structural Motifs](https://arxiv.org/pdf/2002.03230.pdf) --> :computer: [code](https://github.com/wengong-jin/hgraph2graph/) ⭐ 442 | 🐛 44 | 🌐 Python | 📅 2022-06-28
...
(2020) [GraSeq: Graph and Sequence Fusion Learning for Molecular Property Prediction](https://gitlab.com/7tm/smel/-/blob/master/papers/graseq.pdf) --> :computer: [code](https://github.com/zhichunguo/GraSeq) ⭐ 15 | 🐛 1 | 🌐 Python | 📅 2021-02-10
...
(2019) [Junction Tree Variational Autoencoder for Molecular Graph Generation](https://arxiv.org/pdf/1802.04364.pdf) --> :computer: [Code](https://github.com/wengong-jin/icml18-jtnn) ⭐ 564 | 🐛 30 | 🌐 Python | 📅 2022-12-01
...
(2019) [Molecular Property Prediction: A Multilevel Quantum Interactions Modeling Perspective](https://gitlab.com/7tm/smel/-/blob/master/papers/molecular_property_prediction.pdf) --> :computer: [code](https://github.com/awslabs/dgl-lifesci/blob/master/python/dgllife/model/model_zoo/mgcn_predictor.py) ⭐ 809 | 🐛 32 | 🌐 Python | 📅 2023-11-01 --> :computer: [more code](https://github.com/tencent-alchemy/Alchemy) ⭐ 114 | 🐛 6 | 🌐 Python | 📅 2024-07-25
...
(2019) [eToxPred: a machine learning-based approach to estimate the toxicity of drug candidates](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6325674/) --> :computer: [eToxPred code](https://github.com/pulimeng/etoxpred) ⭐ 51 | 🐛 6 | 🌐 Python | 📅 2025-05-07

(2018) [Seq3Seq Fingerprint: Towards End-to-end Semi-supervised Deep Drug Discovery](https://gitlab.com/7tm/smel/-/blob/master/papers/seq3seq.pdf) --> :computer: [code](https://github.com/xysteve00/seq3seq-fingerprint-regression) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2018-11-21
...
(2018) [(MOSES): A Benchmarking Platform for Molecular Generation Models](https://arxiv.org/abs/1811.12823) --> :computer: [code](https://github.com/molecularsets/moses) ⭐ 986 | 🐛 31 | 🌐 Python | 📅 2024-07-08
...
(2021) [Genetic determinants of blood-cell traits influence susceptibility to childhood acute lymphoblastic leukemia](https://github.com/sevenTMers/awesome-mendelian-randomisation/blob/main/resources/genetic_deterinmaants_of_blood_cell_traits.pdf) ⭐ 1 | 🐛 0 | 📅 2021-12-07
...
* [Polars](https://github.com/pola-rs/polars) ⭐ 39,436 | 🐛 2,857 | 🌐 Rust | 📅 2026-08-21 - everyone learns the hard way that Pandas doesn't cut it in the real world. Its like [Arrow](https://github.com/apache/arrow) ⭐ 17,039 | 🐛 2,582 | 🌐 C++ | 📅 2026-08-22 only Rusty.
* [Jax](https://github.com/google/jax) ⭐ 36,196 | 🐛 2,465 | 🌐 Python | 📅 2026-08-22 - the future? of domain specific ML compiling?
* [Annoy](https://github.com/spotify/annoy) ⭐ 14,285 | 🐛 85 | 🌐 C++ | 📅 2025-10-29 - the standard in production nearest neighbor
...
AF2 predicts 3D coordinates of all atoms of a protein, [using the amino acid sequence and aligned sequences homology.](https://github.com/b0mTrady/awesome-structural-bioinformatics) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2023-05-05
...
If you didn't know jax's [nn.logsoftmax](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/nn/functions.py#L264) ⭐ 36,196 | 🐛 2,465 | 🌐 Python | 📅 2026-08-22 AF2's implemenation would not mean much to you.
...
* [`lax.stop_gradient`](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/lax/lax.py#L1661) ⭐ 36,196 | 🐛 2,465 | 🌐 Python | 📅 2026-08-22 - is the identity function, that is, it returns argument `x` unchanged. However, `stop_gradient` prevents the flow of
...
This in turn relies upon [`tree_map`](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/tree_util.py#L144) ⭐ 36,196 | 🐛 2,465 | 🌐 Python | 📅 2026-08-22
...
[Jax MD](https://github.com/google/jax-md) ⭐ 1,456 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2026-08-18
...
[Artificial Intelligence: A Modern Approach](https://github.com/aimacode/aima-python) ⭐ 8,797 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-06-30 🤖 The Gospel of Machine Learning
