...
* [:computer: Code](https://github.com/deepmind/alphafold) ⭐ 14,817 | 🐛 307 | 🌐 Python | 📅 2026-04-22
...
* [:floppy\_disk: Code](https://github.com/deepmind/deepmind-research/tree/master/alphafold_casp13) ⭐ 15,175 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17
...
[Deep Variant](https://github.com/google/deepvariant) ⭐ 3,796 | 🐛 5 | 🌐 Python | 📅 2026-03-19 - analysis pipeline that uses a deep neural network to call genetic variants from next-generation DNA sequencing data
...
* [Polars](https://github.com/pola-rs/polars) ⭐ 39,549 | 🐛 2,879 | 🌐 Rust | 📅 2026-08-30 - everyone learns the hard way that Pandas doesn't cut it in the real world. Its like [Arrow](https://github.com/apache/arrow) ⭐ 17,072 | 🐛 2,588 | 🌐 C++ | 📅 2026-08-28 only Rusty.
* [Jax](https://github.com/google/jax) ⭐ 36,226 | 🐛 2,493 | 🌐 Python | 📅 2026-08-30 - the future? of domain specific ML compiling?
...
If you didn't know jax's [nn.logsoftmax](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/nn/functions.py#L264) ⭐ 36,226 | 🐛 2,493 | 🌐 Python | 📅 2026-08-30 AF2's implemenation would not mean much to you.
...
* [`lax.stop_gradient`](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/lax/lax.py#L1661) ⭐ 36,226 | 🐛 2,493 | 🌐 Python | 📅 2026-08-30 - is the identity function, that is, it returns argument `x` unchanged. However, `stop_gradient` prevents the flow of
...
This in turn relies upon [`tree_map`](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/tree_util.py#L144) ⭐ 36,226 | 🐛 2,493 | 🌐 Python | 📅 2026-08-30
...
[Artificial Intelligence: A Modern Approach](https://github.com/aimacode/aima-python) ⭐ 8,801 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-06-30 🤖 The Gospel of Machine Learning
