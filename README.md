...
[AutoDock GPU](https://github.com/ccsb-scripps/AutoDock-GPU) ⭐ 613 | 🐛 89 | 🌐 C++ | 📅 2026-08-11
...
[BioWasm](https://github.com/biowasm/biowasm) ⭐ 277 | 🐛 8 | 🌐 HTML | 📅 2026-09-15 - WebAssembly modules for genomics
...
[VG](https://github.com/vgteam/vg) ⭐ 1,335 | 🐛 385 | 🌐 C++ | 📅 2026-09-19 - tools for working with genome variation graphs
...
* [Polars](https://github.com/pola-rs/polars) ⭐ 39,820 | 🐛 2,900 | 🌐 Rust | 📅 2026-09-21 - everyone learns the hard way that Pandas doesn't cut it in the real world. Its like [Arrow](https://github.com/apache/arrow) ⭐ 17,142 | 🐛 2,551 | 🌐 C++ | 📅 2026-09-21 only Rusty.
* [Jax](https://github.com/google/jax) ⭐ 36,318 | 🐛 2,590 | 🌐 Python | 📅 2026-09-21 - the future? of domain specific ML compiling?
...
If you didn't know jax's [nn.logsoftmax](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/nn/functions.py#L264) ⭐ 36,318 | 🐛 2,590 | 🌐 Python | 📅 2026-09-21 AF2's implemenation would not mean much to you.
...
* [`lax.stop_gradient`](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/lax/lax.py#L1661) ⭐ 36,318 | 🐛 2,590 | 🌐 Python | 📅 2026-09-21 - is the identity function, that is, it returns argument `x` unchanged. However, `stop_gradient` prevents the flow of
...
This in turn relies upon [`tree_map`](https://github.com/google/jax/blob/890a41f7191fa468e2f638ba4efb9e32ad26adaa/jax/_src/tree_util.py#L144) ⭐ 36,318 | 🐛 2,590 | 🌐 Python | 📅 2026-09-21
